...
INSERT INTO [tpi2023tm01].[dbo].[usuarios] (Contrase�a, PersonaDni, TipoDeUsuarioId)
...
(1, 2023, 'Dise�o de Sistemas de Informacion', 6, 150),
(1, 2008, 'Gestion de Datos', 4, 120);

INSERT INTO [tpi2023tm01].[dbo].[cursos] (IdMateria, A�o, cupo)
VALUES
(1, 2023, 40),
(1, 2022, 35),
(3, 2023, 40);